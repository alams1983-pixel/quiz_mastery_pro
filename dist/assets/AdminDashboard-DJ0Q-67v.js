import{r as P,k as M,g as R,i as z,_ as U}from"./index--RLdyeHQ.js";import{renderMath as H}from"./katexRenderer-OjKm2_7m.js";import{p as G,a as F}from"./csvJsonParser-BYEbs1eI.js";import{createModal as V}from"./Modal-gSRHaNEz.js";function I({initialQuestion:x,onSave:f,onCancel:w}){const t=document.createElement("div");t.className="math-editor-grid",t.style.display="grid",t.style.gridTemplateColumns="1fr 1fr",t.style.gap="20px";const p=x||{question_text:"",options:["","","",""],correct_answer_index:0,explanation:""};t.innerHTML=`
    <!-- Left Pane: Inputs -->
