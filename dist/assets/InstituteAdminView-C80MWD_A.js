const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-DUNGS5AN.js","assets/index-CyV29KP3.js","assets/index-CG2BOuPD.css","assets/QuestionBankSelectorModal-B6TLDOdm.js","assets/LoadingOverlayModal-CS1Ac5fD.js"])))=>i.map(i=>d[i]);
import{r as b,c as Z,_ as G}from"./index-CyV29KP3.js";function re(e){const o=document.createElement("div");return o.className="view-container fade-in",o.innerHTML=`
  ...
  `,document.body.appendChild(n);const t=()=>n.remove();n.querySelector("#close-builder-modal").addEventListener("click",t),n.querySelector("#done-builder-modal").addEventListener("click",t),await c();async function c(){const a=n.querySelector("#builder-body-content");try{const S=(await b(`/exams/${o.id}/sections-questions`)).sections||[];if(S.length===0){a.innerHTML=`
        ...
        `;return}const{openQuestionBankSelectorModal:z}=await G(async()=>{const{openQuestionBankSelectorModal:s}=await import("./QuestionBankSelectorModal-B6TLDOdm.js");return{openQuestionBankSelectorModal:s}},__vite__mapDeps([3,1,2,4])),{renderMath:A}=await G(async()=>{const{renderMath:s}=await import("./index-CyV29KP3.js").then(r=>r.i);return{renderMath:s}},__vite__mapDeps([1,2]));a.innerHTML=`
