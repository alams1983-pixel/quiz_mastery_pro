const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-B0JptRNF.js","assets/index-DegNbP46.js","assets/index-0wnOhacZ.css","assets/QuestionBankSelectorModal-Dgd0_uwx.js","assets/katexRenderer-BsdH79S5.js","assets/LoadingOverlayModal-CS1Ac5fD.js"])))=>i.map(i=>d[i]);
import{r as g,_ as ee}from"./index-DegNbP46.js";import{createModal as pe}from"./Modal-gSRHaNEz.js";function we(e,r="exams"){const l=document.createElement("div");return l.className="view-container fade-in",l.innerHTML=`
