import{g as y,a as h,s as v}from"./index-w1j3NIg4.js";function k(s){const e=document.createElement("div");e.className="container page-view",e.style.maxWidth="1000px",e.style.padding="2rem 1rem";const o=y();if(!o)return s("login"),e;const c=h();e.innerHTML=`
    <!-- Page Header -->
