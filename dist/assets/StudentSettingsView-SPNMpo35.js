import{g as v,C as f,o as h,s as x}from"./index-7hSgpPgK.js";function k(l){const r=document.createElement("div");r.className="container page-view",r.style.maxWidth="1000px",r.style.padding="2rem 1rem";const t=v();if(!t)return l("login"),r;r.innerHTML=`
    <!-- Page Header -->
