/**
 * LoadingOverlayModal.js
 * Reusable Fullscreen Frosted Glass Loading Indicator Modal
 */

let activeOverlay = null;

export function showLoadingOverlay(title = 'Loading Data...', subtitle = 'Please wait while we process your request...') {
  hideLoadingOverlay();
  ...
  if (!document.getElementById('style-loading-spin')) {
    const style = document.createElement('style');
    style.id = 'style-loading-spin';
    style.innerHTML = `
  ...
  return {
    updateMessage: (newTitle, newSubtitle) => {
      const titleEl = modal.querySelector('#loading-overlay-title');
      const subEl = modal.querySelector('#loading-overlay-subtitle');
