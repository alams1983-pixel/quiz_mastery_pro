const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-DIktfpwO.js","assets/index--RLdyeHQ.js","assets/index-DNPoVxEo.css","assets/QuestionBankSelectorModal-Bwl421bS.js","assets/katexRenderer-OjKm2_7m.js","assets/LoadingOverlayModal-CS1Ac5fD.js"])))=>i.map(i=>d[i]);
import{r as g,_ as ee}from"./index--RLdyeHQ.js";import{createModal as pe}from"./Modal-gSRHaNEz.js";function we(e,r="exams"){const l=document.createElement("div");return l.className="view-container fade-in",l.innerHTML=`
