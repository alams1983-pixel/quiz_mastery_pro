import{g as _}from"./index-w1j3NIg4.js";function P(r){const e=document.createElement("div");e.className="container page-view",e.style.maxWidth="1050px",e.style.padding="2rem 1rem";const l=_();if(!l||l.role!=="institute_admin"&&l.role!=="admin"&&l.role!=="super_admin")return alert("Access denied. Coaching Institute Admin privileges required."),r("dashboard"),e;e.innerHTML=`
    <!-- Header -->
