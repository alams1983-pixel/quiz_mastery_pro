import{g as f,r as l}from"./index-DVSz0i_J.js";function S(t){const e=document.createElement("div");e.className="view-container fade-in";const a=f()||{role:"user"};return a.role==="super_admin"?b(e):a.role==="institute_admin"||a.role==="admin"?h(e):x(e,t),e}async function x(t,e){t.innerHTML=`
