const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BulkUploadModal-zivyE2PO.js","assets/csvJsonParser-Cmc2jVv8.js","assets/index-DVSz0i_J.js","assets/index-BH0bcMe9.css"])))=>i.map(i=>d[i]);
import{s as M,r as y,h as P,_ as B,a as A}from"./index-DVSz0i_J.js";let _=[],w=[],$=[],x=null,L="all",p=1,E=20,k={total:0,page:1,limit:20,totalPages:1,hasNextPage:!1,hasPrevPage:!1},S=null;function I(i,r={}){x=typeof i=="function"?i:null,p=1;const o=document.createElement("div");return o.className="view-container fade-in",o.innerHTML=`
  ...
  `;r&&(r.innerHTML=m),o&&(o.innerHTML=m),[r,o].forEach(d=>{var b,g,u,v,f;d&&((b=d.querySelector(".btn-page-first"))==null||b.addEventListener("click",()=>{p>1&&(p=1,c(i))}),(g=d.querySelector(".btn-page-prev"))==null||g.addEventListener("click",()=>{p>1&&(p--,c(i))}),(u=d.querySelector(".btn-page-next"))==null||u.addEventListener("click",()=>{p<e&&(p++,c(i))}),(v=d.querySelector(".btn-page-last"))==null||v.addEventListener("click",()=>{p<e&&(p=e,c(i))}),(f=d.querySelector(".select-page-limit"))==null||f.addEventListener("change",h=>{E=parseInt(h.target.value,10)||20,p=1,c(i)}))})}function Q(i,r){const o=i.querySelector("#questions-list-container");if(!o)return;if(!r||r.length===0){o.innerHTML=`
    ...
    `).join(""),l=!!t.is_global,m=t.options_en||[],d=t.options_hi||[],b=t.options_images||[];return`
      <div class="card" style="padding: 20px; border-left: 4px solid ${l?"var(--primary)":"var(--accent)"}; background: ${l?"rgba(59, 130, 246, 0.02)":"var(--card-bg)"};">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 10px; margin-bottom: 14px;">
          ${m.map((g,u)=>{const v=u===t.correct_option_index,f=d[u]||"",h=b[u]||"";return`
              <div style="padding: 10px 12px; border-radius: 8px; border: 1px solid ${v?"var(--success)":"var(--border-color)"}; background: ${v?"rgba(34,197,94,0.08)":"var(--bg-color)"}; font-size: 0.9rem;">
                <div style="display: flex; align-items: flex-start; gap: 6px;">
                  <strong style="color: ${v?"var(--success)":"var(--primary)"}; width: 24px;">
                    ${String.fromCharCode(65+u)}:
                  </strong>
                  <div style="flex: 1;">
                    <div style="white-space: pre-line;" class="katex-render">${g}</div>
                    ${f?`<div style="font-size: 0.82rem; color: var(--text-muted); margin-top: 2px; white-space: pre-line;" class="katex-render">${f}</div>`:""}
                  ...
                  ${v?'<span style="color:var(--success); font-weight:bold; font-size:1.1rem;">✓</span>':""}
                </div>
              </div>
            `}).join("")}
        </div>
