const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-M3T_NKR4.js","assets/index-CRSLeMRF.js","assets/index-C5OHzuFU.css","assets/QuestionBankSelectorModal-UjB3QWqk.js","assets/katexRenderer-DBVwVh_W.js","assets/LoadingOverlayModal-CS1Ac5fD.js"])))=>i.map(i=>d[i]);
import{r as g,_ as ee}from"./index-CRSLeMRF.js";import{createModal as pe}from"./Modal-gSRHaNEz.js";function we(e,r="exams"){const l=document.createElement("div");return l.className="view-container fade-in",l.innerHTML=`
