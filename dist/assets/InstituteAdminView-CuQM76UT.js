const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-DYesCUjr.js","assets/index-BXctJt8i.js","assets/index-BOpXQoyT.css","assets/QuestionBankSelectorModal-BLm1bqOP.js","assets/katexRenderer-BNqWl4nT.js","assets/LoadingOverlayModal-CS1Ac5fD.js"])))=>i.map(i=>d[i]);
import{r as g,_ as ee}from"./index-BXctJt8i.js";import{createModal as pe}from"./Modal-gSRHaNEz.js";function we(e,r="exams"){const l=document.createElement("div");return l.className="view-container fade-in",l.innerHTML=`
