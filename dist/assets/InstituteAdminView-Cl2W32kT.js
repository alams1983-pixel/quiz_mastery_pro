const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-DliRva7T.js","assets/index-Rg-hsdDB.js","assets/index-DZNZSRn5.css","assets/QuestionBankSelectorModal-D1t4ryTn.js","assets/katexRenderer-CjjCMCry.js","assets/LoadingOverlayModal-CS1Ac5fD.js"])))=>i.map(i=>d[i]);
import{r as g,_ as ee}from"./index-Rg-hsdDB.js";import{createModal as pe}from"./Modal-gSRHaNEz.js";function we(e,r="exams"){const l=document.createElement("div");return l.className="view-container fade-in",l.innerHTML=`
