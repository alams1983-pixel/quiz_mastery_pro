const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardModal-BFlgHJ0q.js","assets/index-w1j3NIg4.js","assets/index-CG2BOuPD.css","assets/QuestionBankSelectorModal-kFM9M5Dt.js"])))=>i.map(i=>d[i]);
import{r as b,c as U,_ as R}from"./index-w1j3NIg4.js";function ae(e){const o=document.createElement("div");return o.className="view-container fade-in",o.innerHTML=`
  ...
  `,document.body.appendChild(i);const t=()=>i.remove();i.querySelector("#close-builder-modal").addEventListener("click",t),i.querySelector("#done-builder-modal").addEventListener("click",t),await d();async function d(){const a=i.querySelector("#builder-body-content");try{const k=(await b(`/exams/${o.id}/sections-questions`)).sections||[];if(k.length===0){a.innerHTML=`
        ...
        `;return}const{openQuestionBankSelectorModal:L}=await R(async()=>{const{openQuestionBankSelectorModal:l}=await import("./QuestionBankSelectorModal-kFM9M5Dt.js");return{openQuestionBankSelectorModal:l}},__vite__mapDeps([3,1,2])),{renderMath:_}=await R(async()=>{const{renderMath:l}=await import("./index-w1j3NIg4.js").then(u=>u.j);return{renderMath:l}},__vite__mapDeps([1,2]));a.innerHTML=k.map(l=>`
